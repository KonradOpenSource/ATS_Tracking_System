...
import { createAccumulationObservable, createSideEffectObservable, safePluck, isKeyOf, select } from '@rx-angular/state/selections';
...
class RxState {
    ...
    connect(keyOrInputOrSlice$, projectOrSlices$, projectValueFn) {
        ...
        if (projectValueFn === undefined &&
            ...
            const slice$ = projectOrSlices$.pipe(map((value) => ({ ...{}, [key]: value })));
            this.accumulator.nextSliceObservable(slice$);
            return;
        }
...
/** @nocollapse */ RxState.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.12", ngImport: i0, type: RxState, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
/** @nocollapse */ RxState.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "13.3.12", ngImport: i0, type: RxState });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.12", ngImport: i0, type: RxState, decorators: [{
            type: Injectable
